 ...
 * density 同時管字級與 body 儲存格內距 ( 間距章兩檔制 + 文字章兩軌制,2026.7.20 拍板 ):
 *   default = 頁面級主資料表:字級 Body1 ( 16px )、body 儲存格垂直內距 16px
 *   dense   = 內嵌於彈窗/面板/表單的輔助表:字級 Body2 ( 14px )、body 儲存格垂直內距 12px
 * 表頭 ( DataTableHead ) 垂直內距固定 12px,不隨 density 變動 ( 2026.7.28 拍板:原 default 16px 太高調降 )
