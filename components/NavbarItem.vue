 ...
 *
 * 逐字對照存取節點 AppNav.vue 選單項搬移，未選 fg-secondary-default 文字 + 500 字重、hover 加深、
...
<template>
  <RouterLink
    :to="to"
    class="relative flex h-full items-center px-4 font-medium text-fg-secondary-default whitespace-nowrap transition-colors hover:text-fg-secondary-hover"
